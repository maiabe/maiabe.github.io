...
<br>	- Create a web page mock-up for the app
<br>	- Implement the Yeelight to connect to the app
<br>	- Implement 'Landing', 'Sign-In', and 'Sign-out' pages
<br>	- Implement 'User Home' page that includes a calendar that shows the predictions</p>
